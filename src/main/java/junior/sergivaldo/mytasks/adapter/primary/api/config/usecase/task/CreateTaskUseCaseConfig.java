...
public class CreateTaskUseCaseConfig {
    ...
    @Bean
    public CreateTaskUseCase createTaskUseCaseImpl(UpdateTaskListUseCase updateTaskListUseCase, CreateTaskAdapter createTaskAdapter, FindTaskListByIdUseCase findTaskListByIdUseCase) {
        return new CreateTaskUseCaseImpl(findTaskListByIdUseCase,updateTaskListUseCase, createTaskAdapter);
    }
}
